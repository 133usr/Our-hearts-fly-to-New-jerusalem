...
// const flightData = [
//   {"longitude":12.64878,"latitude":55.62493,"height":4000.94},
//   {"longitude":12.64904,"latitude":55.62492,"height":4000.94},
//   {"longitude":12.64928,"latitude":55.62491,"height":4000.94},
//   {"longitude":12.64936,"latitude":55.6249,"height":4000.94},
//   {"longitude":12.64949,"latitude":55.62442,"height":4000.94},
//   {"longitude":12.64936,"latitude":55.6247,"height":4000.94}
// ];
...
const loadModels = async (tempsheetObject) => {
  const suratLongitude = 72.8777; // Surat's longitude
  const suratLatitude = 21.1702; // Surat's latitude
  const suratAltitude = 150; // You may adjust the altitude as needed
   ...
   // Scale of the selected model
      ...
      const loadModel = async () => {
        ...
        const suratPosition = Cesium.Cartesian3.fromDegrees(suratLongitude, suratLatitude, suratAltitude);
    airplaneEntity.position = suratPosition;
